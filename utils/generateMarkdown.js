...
function renderOtherBadges(answers) {
    return`![GitHub last commit](https://img.shields.io/github/last-commit/${answers.user.github}/${answers.title}) ![GitHub Workflow Status](https://img.shields.io/github/workflow/status/${answers.user.github}/${answers.title}/Jest) ![GitHub top language](https://img.shields.io/github/languages/top/${answers.user.github}/${answers.title}) ![GitHub language count](https://img.shields.io/github/languages/count/${answers.user.github}/${answers.title}) [![GitHub followers](https://img.shields.io/github/followers/${answers.user.github}?style=social)](https://github.com/kbario)`
}
